...
5. The new call leg contains new Diversion header that let's receiving party know that this is a forwarded call. This can be key for successfully delivering calls to MVNOs. The reason in the Diversion header should follow this RFC standard https://www.rfc-editor.org/rfc/rfc5806#:~:text=URI.%0A%0A4.-,Extension%20Syntax,-The%20syntax%20of
